...
class icalls {
    ...
    // Added for STS: Gdx2DPixmap.drawPixmap(JJIIIIIIII)V -> (JNIEnv*,jclass,jlong,jlong,jint x8).
    [DllImport("icalls")]
    static internal extern void wasm_icall_viilliiiiiiii(int a, int b, long c, long d, int e, int f, int g, int h, int i, int j, int k, int l);
    // Added for STS: gdx-freetype JNI signatures missing from the base set.
    [DllImport("icalls")]
    static internal extern int wasm_icall_iii(int a0, int a1);
    [DllImport("icalls")]
    static internal extern int wasm_icall_iiil(int a0, int a1, long a2);
    [DllImport("icalls")]
    static internal extern int wasm_icall_iiiliiii(int a0, int a1, long a2, int a3, int a4, int a5, int a6);
    [DllImport("icalls")]
